...
|---|---|---|---|
| Finding A | E2E-01--04 superseded compositions | **Fixed** | Module 19, `e2eProcesses.js` |
| Finding B | 7 vs. 8 transformation types | **Decision recorded** --- kept 8 | Module 19 |
...
| Gap 4.1 (E2E RACSI) | Per-chain RACSI on core E2E chains | **Closed** | Module 19 |
| Gap 4.2 (Cross-Type Matrix) | 8-type side-by-side comparison | **Closed** | Module 15 |
| Gap 4.3 (WBS refinements) | Accountability tag, P1--P7 phase filter | **Closed** | Module 18 |
| Gap 4.4 (Phase Gate/Checklist) | Selectable Accountable role, weighted checklist items | **Closed** | Module 18 |
| Gap 4.5 (REX log) | Lesson-to-Rule/Control/Charter closure field | **Closed** | Module 13 |
| Gap 4.6 (Charter Registry) | D31 charters, action mapping, mentoring model | **Closed** | Module 20 (new) |
| Gap 4.6 (Journeys/Analytics) | D27/D28/D29 journeys, touchpoints, dashboards | **Closed** | Module 21 (new) |
| Gap 4.6 (Context Overlay) | D24 project-context overlay | **Closed** (reference) | Module 21 |
| Gap 4.7 (Coding Workbench) | D32k codebook, tagging, frequency rollup | **Closed** | Module 11 |
| Gap 4.8 (NLP Theme-Mining Engine) | D32j backend NLP engine | **Architectural boundary** | Section 6 |
| Gap 4.9 (Alerts/D07) | Sixteen alert conditions, in-app delivery | **Partially closed** --- 8 of 16 live-computed | Notification Center (new) |
| Gap 4.10 (Reporting export/D08) | Server-side Excel/PDF export | **Partially closed** --- client-side CSV | M8, M9, M10, M14, M15 |
...
Module 19's E2E Process Registry tab.
...
retained across Module 18's Phase Template picker, Module 19's E2E
Registry, and the seed dataset's fifth CR1 expansion case. Where a
newly-built feature transcribes a 7-type source table verbatim (Module
15's Cross-Type Comparison Matrix, sourced from D32i), the 8th
...
**Module 15 --- Metrics & Analytics Dashboard.** New Cross-Type
...
**Module 18 --- Work Breakdown Structure & Gantt.** A task's delivery
...
**Module 13 --- Reinforcement & Sustainment.** Each lesson-learned entry
...
**Module 20 --- Change Management Charter Registry (new module).** All
...
**Module 21 --- Stakeholder Journeys, Touchpoints & Analytics (new
...
**Module 11 --- Resistance Management.** New Coding Workbench tab: an
...
definitions catalogued; eight --- Divergence Pattern, Regression Risk
Critical, Sponsor Coverage Gap, Resistance Escalation Threshold, Change
Saturation Threshold, Phase Gate No-Go/Conditional, Guiding Coalition
Gap, and Sustainment Sign-Off Blocked --- fire live from data journi
already holds, with severity, SLA threshold and recipient-role shown
per alert, and per-project dismissal that persists across reloads (Gap
4.9, see Section 6 for why the remaining eight do not fire).
...
- **Server-side persistence, multi-device access, backups.** journi's
  ...
  it.
- **A BPMN/DMN workflow-execution engine.** Module 19 makes the process
...
- **A COSO-aligned control-testing framework.** Module 14's risk
...
- **Real outbound alert delivery** (D07's email, push notification and
  ...
  Eight of D07's sixteen alerts additionally depend on infrastructure
  ...
  never fire, by the same logic.
- **A purpose-built NLP embeddings backend** (D32j). Module 17's AI Use
  Case Library and Module 11's Coding Workbench run against a
