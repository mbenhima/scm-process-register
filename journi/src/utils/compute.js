...
/** Composite Readiness Index (0-100), blending ADKAR, sentiment and training completion — Module 20 */
...
/** Module 10: escalation rule — a block stalled at <=2 is flagged to the Change Manager */
export function stalledBlocks(project) {
  return ADKAR_BLOCKS.filter((b) => isBlockStalled(project.adkar[b]))
}

/** Module 11: divergence — strong capability (Knowledge/Ability) but still emotionally "Ending" */
...
/** Module 12 — flags orgs where >1 concurrent CM project may be hitting overlapping populations */
