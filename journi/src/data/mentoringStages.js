// Module 20 — Mentoring Progression Model (D31c): the detailed 3-stage
...
const mentoringStages = [
  {
    ...
    entryCriteria: 'Completed role-based curriculum (Module 10); assigned to a named Mentor',
    ...
    setting: 'Sandbox / practice environment (Module 10)',
  ...
  },
  {
    ...
    order: 3,
    description:
      "The mentee performs the live process unsupervised; Mentor involvement shifts from direct oversight to periodic spot-audit, matching Module 10's 'trained vs. capable' distinction.",
    ...
    mentorInvolvement: 'Minimal — periodic spot-audit only, per Module 13 reinforcement cadence',
    ...
    regressionPath:
      'A spot-audit failure or a Module 13 regression flag can return the individual to Observer stage (MENT-02) for targeted re-coaching rather than restarting the full mentoring cycle.',
  },
]
