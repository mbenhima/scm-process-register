// Module 4 — End-to-End Process Registry (D32h).
...
const e2eProcesses = [
  ...
  },
  {
    ...
    relatedModules: ['M14', 'M15', 'M10', 'M11', 'M12'],
  ...
  },
  {
    ...
    relatedModules: ['M13', 'M12', 'M8'],
    note: 'Cross-references adoption-risk entries (MP-08) against linked Main Project schedule slips. Implemented in M8 as the Phase Gate / Joint Decision Record feature.',
  },
  {
    id: 'E2E-07',
  ...
  },
  {
    ...
    relatedModules: ['M13', 'M21'],
    note: 'Weakest-evidence proposed loop; included for completeness. Largely covered by existing Sponsor Coalition escalation actions (M13) and Sustainment checkpoints (M21).',
  },
  {
    id: 'E2E-ERP',
