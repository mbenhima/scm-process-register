// Module 21 — Journey Analytics Dashboards (D29): the experience-centric
// companion to journi's existing score-centric analytics (M6/M14/M15) —
...
// touchpointLog / charterActionLog (see Module21Page); DASH-03/04/05 are
// shown as descriptive reference cards — this demo doesn't model per-mentee
// or per-case granularity separately from the underlying M20/M14 logs.
const journeyDashboards = [
  ...
  },
  {
    ...
    live: 'charterActions',
    description: 'Rolls up Charter Action Mapping (M20) completion against the charter each action belongs to, cross-referenced with JRN-02 touchpoints.',
  },
  {
    id: 'DASH-03',
