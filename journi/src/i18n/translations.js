...
const dict = {
  ...
  requireJustification: { en: 'Justification', fr: 'Justification', ar: 'التبرير' },
  justificationMandatory: { en: 'Mandatory', fr: 'Obligatoire', ar: 'إلزامي' },
  justificationOptional: { en: 'Optional', fr: 'Facultatif', ar: 'اختياري' },
  justificationRequiredHint: { en: 'A justification note is required by this Organization before saving.', fr: 'Une note de justification est requise par cette Organisation avant l’enregistrement.', ar: 'يشترط هذا التنظيم كتابة مذكرة تبرير قبل الحفظ.' },
  justificationOptionalOrgHint: { en: 'Justification is optional for this Organization — still recommended.', fr: 'La justification est facultative pour cette Organisation — toujours recommandée.', ar: 'التبرير اختياري لهذا التنظيم — يبقى موصى به.' },
