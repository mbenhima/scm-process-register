...
export default function RegisterPage() {
  ...
  return (
    <AuthShell wide>
      ...
      <h1 className="h-page mb-6">Create your DynamicBA account</h1>
      ...
      <div className="flex gap-2 mb-6" role="tablist">
        <button
          ...
          className={`tab-button flex-1 !text-sm ${mode === 'create' ? 'tab-button-active' : 'tab-button-inactive'}`}
        ...
        <button
          ...
          className={`tab-button flex-1 !text-sm ${mode === 'join' ? 'tab-button-active' : 'tab-button-inactive'}`}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input className="input" value={form.name} onChange={(e) => set('name', e.target.value)} required autoComplete="name" />
          </div>
          <div>
        ...
        <div>
          ...
          <input className="input" type="password" minLength={6} value={form.password} onChange={(e) => set('password', e.target.value)} required autoComplete="new-password" />
        </div>
