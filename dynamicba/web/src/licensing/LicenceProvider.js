...
// This build implements the "SaaS" path from D30 Section 4, adapted to a locally-run
// full-stack app: the licence record lives in the server's own database
// (server/data/db.json, table `licences`) instead of a cloud Firestore document, and is
// fetched over the app's own REST API rather than a Firebase SDK call. OnPremLicenceProvider
// is included only as a documented stub — a signed-.lic-file flow per D30 Section 5 is a
// clean extension point, not something this build needed (see the Installation Guide).
//
